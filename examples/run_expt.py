    ...
    for split in splits:
        ...
        for subsplit in subsplits:
            if split == 'train':
                ...
                datasets[subsplit]['loader'] = get_eval_loader(
            ...
            # Loggers
            datasets[subsplit]['eval_logger'] = BatchLogger(
                os.path.join(config.log_dir, f'{subsplit}_eval.csv'), mode=mode, use_wandb=(config.use_wandb and verbose))
            datasets[subsplit]['algo_logger'] = BatchLogger(
                os.path.join(config.log_dir, f'{subsplit}_algo.csv'), mode=mode, use_wandb=(config.use_wandb and verbose))
